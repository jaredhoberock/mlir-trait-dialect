...
// generic over !S and the premise redex proj<@Sib[!S],"Elem"> quantifies over
// that parameter while citing the single-instance impl @Sib_i64. Were the redex
// allowed, its poly variable would unify with the cited impl's concrete head and
// this generic impl would be accepted at birth on the strength of ONE instance.
// The seam refuses a non-ground redex outright, mirroring the guard the retired
// candidate lookup applied.
