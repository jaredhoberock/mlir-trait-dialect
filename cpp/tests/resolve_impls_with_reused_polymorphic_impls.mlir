...
trait.impl private @A_impl for @A[i1] {}

!B = !trait.poly<1>
trait.trait private @B[!B] {}

// 0-tuple impl for @B
trait.impl private @B_tuple_impl_arity_0 for @B[tuple<>] {}

// 1-tuple impl for @B
!C = !trait.poly<2>
trait.impl private @B_tuple_impl_arity_1 for @B[tuple<!C>] where [
  @A[!C]
] {}
...
!D = !trait.poly<3>
!E = !trait.poly<4>
trait.impl private @B_tuple_impl_arity_2 for @B[tuple<!D, !E>] where [
  @A[!D],
  @A[!E]
] {}
