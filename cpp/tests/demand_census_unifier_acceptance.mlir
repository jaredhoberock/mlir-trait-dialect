...
// CHECK: trait-demand-census demand flags=real drainable=no observations=2 depth=0
...
// CHECK: trait-demand-census summary keys=1 observations=2 drainable-keys=0
