...
// expected-error @below {{declared claim in signature has an invalid proof: proof @HasPart_i64 proves '!trait.claim<@HasPart[i64]>', which does not discharge the obligation '!trait.claim<@Other[f32]>'}}
